...
<main>
  ...
  <article class="article-single">
    ...
    <div class="article-single-layout">
      <!-- Riel izquierdo: tiempo de lectura + compartir (desktop) -->
      <aside class="article-rail">
        <div class="article-rail-sticky">
          <div class="rail-readtime">⏱️ <?php echo (int) $read_min; ?> min de lectura</div>
          <div class="rail-share">
            <span class="rail-share-label">Compartir</span>
