...
<aside class="latest-sidebar">
  ...
  <div class="latest-sidebar-img" style="background-image:url('<?php echo esc_url( $image ); ?>')">
    <img src="<?php echo esc_url( $image ); ?>" alt="<?php echo esc_attr( $imageAlt ); ?>" loading="lazy" style="width:100%; height:100%; object-fit:contain;">
  </div>
