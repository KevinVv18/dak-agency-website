<?php
/**
 * header.php — Complete blog header
...
<!-- Cursor Grid Reveal -->
<div class="cursor-grid-reveal" id="cursorGrid"></div>

<!-- Fixed Mini-Nav (appears on scroll) -->
<div class="mini-nav" id="miniNav">
  <div class="mini-nav-inner">
    <a href="<?php echo home_url( '/' ); ?>" class="mini-nav-logo">
    ...
    <ul class="mini-nav-links">
      ...
      <li><a href="<?php echo home_url( '/#opinion' ); ?>" class="mini-nav-link">VIDEO</a></li>
      <li><a href="<?php echo home_url( '/#opinion' ); ?>" class="mini-nav-link">DISEÑO WEB</a></li>
...
<!-- Main Header (static, scrolls away) -->
<header class="header" id="header">
  ...
  <div class="header-utility">
    <div class="header-utility-inner">
      <div class="utility-left">
        ...
        <span class="date-text"><?php echo dak_format_today_spanish(); ?></span>
      </div>
      <div class="utility-right">
        <div class="header-social">
          <a href="https://www.facebook.com/dakagency" class="social-btn" aria-label="Facebook" target="_blank" rel="noopener">
          ...
          <a href="https://www.instagram.com/dakagency" class="social-btn" aria-label="Instagram" target="_blank" rel="noopener">
          ...
          <a href="https://www.tiktok.com/@dakagency" class="social-btn" aria-label="TikTok" target="_blank" rel="noopener">
          ...
          <a href="https://wa.me/51906765040" class="social-btn" aria-label="WhatsApp" target="_blank" rel="noopener">
  ...
  <div class="masthead" id="masthead">
    <div class="masthead-inner">
      <a href="<?php echo home_url( '/' ); ?>" class="masthead-logo-link">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.svg" alt="DAK Agency" class="masthead-logo-main">
      </a>
      <p class="masthead-subtitle">INFORMANDO</p>
      <p class="masthead-tagline">NOTICIAS · TENDENCIAS · MARKETING DIGITAL — DESDE 2024</p>
    </div>
  </div>
  ...
  <nav class="nav-bar">
    <div class="nav-inner">
      <ul class="nav-menu" id="navMenu">
        ...
        <li><a href="<?php echo home_url( '/#opinion' ); ?>" class="nav-link">VIDEO</a></li>
        <li><a href="<?php echo home_url( '/#opinion' ); ?>" class="nav-link">DISEÑO WEB</a></li>
        <li><a href="<?php echo home_url( '/#opinion' ); ?>" class="nav-link">SEO &amp; ADS</a></li>
      </ul>
    </div>
  </nav>
</header>
