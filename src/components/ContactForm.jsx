      ...
      <div className="contact-layout">
        ...
        >
          ...
          <a
            ...
            className="contact-schedule-cta"
          >
            ...
            <div className="schedule-cta-text">
              <span className="schedule-cta-title">Agenda una reunión gratuita</span>
              <span className="schedule-cta-sub">60 min · Google Meet · Sin compromiso</span>
            </div>
            <svg className="schedule-cta-arrow" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
